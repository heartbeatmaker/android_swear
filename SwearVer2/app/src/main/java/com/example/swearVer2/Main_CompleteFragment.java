...
public class Main_CompleteFragment extends Fragment {
//
//    RecyclerView rcv;
...
//    {
//        RelativeLayout layout = (RelativeLayout) inflater.inflate(R.layout.main_fragment_complete, container, false);
//
//        Log.d("뷰페이저", "completeFragment");
//
...
//                //결과가 확정된 경우
//                else{
//                    Log.d("뷰페이저","complete)"+i+"번째 아이템은 inProgress에 속합니다");
//                }
//            }
//        }
//
